 ...
 *     output_path: scalar|\Symfony\Component\Config\Loader\ParamConfigurator|null, // The path where Encore is building the assets - i.e. Encore.setOutputPath()
 *     crossorigin?: false|"anonymous"|"use-credentials"|\Symfony\Component\Config\Loader\ParamConfigurator, // crossorigin value when Encore.enableIntegrityHashes() is used, can be false (default), anonymous or use-credentials // Default: false
 *     preload?: bool|\Symfony\Component\Config\Loader\ParamConfigurator, // preload all rendered script and link tags automatically via the http2 Link header. // Default: false
 *     cache?: bool|\Symfony\Component\Config\Loader\ParamConfigurator, // Enable caching of the entry point file(s) // Default: false
 *     strict_mode?: bool|\Symfony\Component\Config\Loader\ParamConfigurator, // Throw an exception if the entrypoints.json file is missing or an entry is missing from the data // Default: true
 *     builds?: array<string, scalar|\Symfony\Component\Config\Loader\ParamConfigurator|null>,
 *     script_attributes?: array<string, scalar|\Symfony\Component\Config\Loader\ParamConfigurator|null>,
 *     link_attributes?: array<string, scalar|\Symfony\Component\Config\Loader\ParamConfigurator|null>,
 * }
